#pragma config(Sensor, in8,    liftPotent,     sensorPotentiometer)
...
task autonomous()
{
	if(SensorValue[liftPotent] < 1000)
	{
		motor[lift1] = -127;
		motor[lift2] = -127;
	}
	...
	while(SensorValue[rshaft] < 1350)  // While less than x rotations on the leftEncoder...
	{
		//...Move Forward
